...
<acme:list>
	...
	<acme:list-column code="administrator.trackingLog.list.label.indicator" path="indicator" width="20%"/>
	<acme:list-column code="administrator.trackingLog.list.label.draftMode" path="draftMode" width="20%"/>
